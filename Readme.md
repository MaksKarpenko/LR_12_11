1.git push(git push -u origin master)
2.git clone
3.git merge
4.git merge
5.На ПК
6.Створення різних варіантів одного документу,кожен працює в своєму репозиторії.
7.Відсутність авторизації,нумерація версій файлів,відсутність можливості блокувати файли.
8.Репозиторій — це спеціальний сервер. З такого сервера можна завантажуватити програмне забезпечення, також зберігаються архіви програмних продуктів.
